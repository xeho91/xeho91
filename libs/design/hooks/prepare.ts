...
const OUTPUT_DIR_PALETTE = path.resolve(__dirname, "..", "src", "color", "palette");
...
const COLORS = {
	brand: {
		primary: {
			opaque: { light: radix.purple, dark: radix.purpleDark },
			blend: { light: radix.purpleA, dark: radix.purpleDarkA },
		},
		secondary: {
			opaque: { light: radix.plum, dark: radix.plumDark },
			blend: { light: radix.plumA, dark: radix.plumDarkA },
		},
		accent: {
			opaque: { light: radix.orange, dark: radix.orangeDark },
			blend: { light: radix.orangeA, dark: radix.orangeDarkA },
		},
	},
	semantic: {
		error: {
			opaque: { light: radix.tomato, dark: radix.tomatoDark },
			blend: { light: radix.tomatoA, dark: radix.tomatoDarkA },
		},
		info: {
			opaque: { light: radix.sky, dark: radix.skyDark },
			blend: { light: radix.skyA, dark: radix.skyDarkA },
		},
		success: {
			opaque: { light: radix.lime, dark: radix.limeDark },
			blend: { light: radix.limeA, dark: radix.limeDarkA },
		},
		warning: {
			opaque: { light: radix.amber, dark: radix.amberDark },
	...
	grayscale: {
		...
		gray: {
			opaque: { light: radix.sand, dark: radix.sandDark },
